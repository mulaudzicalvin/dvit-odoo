function restaurant_plus_models(instance, module){ //module is instance.point_of_sale
    "use strict";
    ...
    module.OrderlineCollection = module.OrderlineCollection.extend({
    ...
    module.PaymentlineCollection = module.PaymentlineCollection.extend({
    ...
    module.OrderCollection = module.OrderCollection.extend({
        model: module.Order,
    });
     ...
     */
    module.NumpadState = module.NumpadState.extend({
        defaults: {
            buffer: "0",
            mode: "quantity"
        },
