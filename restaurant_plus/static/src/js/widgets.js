function restaurant_plus_widgets(instance, module){ //module is instance.point_of_sale
    "use strict";

    var QWeb = instance.web.qweb;
	var _t = instance.web._t;

    module.DomCache = module.DomCache.extend({
    ...
    module.HeaderButtonWidget = module.HeaderButtonWidget.extend({
...
// ---------- Main Point of Sale Widget ----------
    ...
    module.StatusWidget = module.StatusWidget.extend({
