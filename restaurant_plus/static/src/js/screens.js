...
function restaurant_plus_screens(instance, module){ //module is instance.point_of_sale
    "use strict";
    ...
    module.PopUpWidget = module.PopUpWidget.extend({
        show: function(){
            if(this.$el){
                this.$el.removeClass('oe_hidden');
            }
    ...
    module.ErrorPopupWidget = module.ErrorPopupWidget.extend({
    ...
    module.ErrorTracebackPopupWidget = module.ErrorTracebackPopupWidget.extend({
        template:'ErrorTracebackPopupWidget',
    });

    module.ErrorBarcodePopupWidget = module.ErrorBarcodePopupWidget.extend({
    ...
    module.ConfirmPopupWidget = module.ConfirmPopupWidget.extend({
